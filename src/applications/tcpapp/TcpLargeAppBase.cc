...
simsignal_t TcpLargeAppBase::connectSignal = registerSignal("connect");

void TcpLargeAppBase::initialize(int stage)
{
...
void TcpLargeAppBase::handleMessageWhenUp(cMessage *msg)
{
...
void TcpLargeAppBase::sendPacket(Packet *msg)
{
...
void TcpLargeAppBase::refreshDisplay() const
{
    ApplicationBase::refreshDisplay();
    getDisplayString().setTagArg("t", 0, TcpSocket::stateName(socket.getState()));
}

void TcpLargeAppBase::socketEstablished(TcpSocket *)
{
    // *redefine* to perform or schedule first sending
    EV_INFO << "connected\n";
}

void TcpLargeAppBase::socketDataArrived(TcpSocket *, Packet *msg, bool)
{
...
void TcpLargeAppBase::socketPeerClosed(TcpSocket *socket_)
{
...
void TcpLargeAppBase::socketClosed(TcpSocket *)
{
    // *redefine* to start another session etc.
    EV_INFO << "connection closed\n";
}

void TcpLargeAppBase::socketFailure(TcpSocket *, int code)
{
